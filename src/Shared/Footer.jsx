...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10  bg-blue-950 text-pink-content">
                <div>
                <FaBookReader className='text-pink-700 text-2xl md:ml-10'></FaBookReader>
                    <h2 className='text-white my-2 text-xl font-bold'>Project Gallery</h2>
                    <p className='text-white'>Providing reliable tech since 1992</p>
                    <p className='text-white'>Copyright © 2023 - All right reserved by Tejgaon College,Dhaka</p>

                </div>
                <div>
                    <h2 className='text-xl text-gray-400'>Address</h2>
                    <p className='text-white'>Indira road,farmgate,dhaka </p>
                    <h2 className='text-xl text-gray-400'>Contact us</h2>
                    <p className='text-white'>phone:000022334556,989900089</p>
                </div>
                <div className='mt-10'>
